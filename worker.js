    ...
    async fetch(request, env, ctx) {
        ...
        if (isRoot && contentType && contentType.includes("text/html")) {
            ...
            const modifiedText5 = modifiedText4.replace(
                '</body>',
                '</body><script>' + logoJs + '</script><script src="https://clickette.instatus.com/en/021b5f0f/widget/script.js"></script><script async defer src="https://s.clickette.net/latest.js"></script> <noscript><img src="https://s.clickette.net/noscript.gif" alt="" referrerpolicy="no-referrer-when-downgrade" /></noscript>'
            );
